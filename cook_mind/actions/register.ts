...
export async function register(formData: FormData) {
  ...
  // intolerances come as multiple checkbox values → join as comma-separated text
  ...
  if (profileError) {
    ...
    return { success: false, message: "Profil introuvable. Le trigger est-il bien configuré ?" };
  }
